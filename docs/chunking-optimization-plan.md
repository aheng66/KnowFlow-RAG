...
- `src/main/java/com/yizhaoqi/knowflow/service/ParseService.java`
- `src/main/java/com/yizhaoqi/knowflow/repository/DocumentVectorRepository.java`
- `src/main/java/com/yizhaoqi/knowflow/service/VectorizationService.java`
- `src/main/resources/application*.yml`
- `src/test/java/com/yizhaoqi/knowflow/service/*ParseService*Test.java`
...
```text
src/main/java/com/yizhaoqi/knowflow/service/chunk/
