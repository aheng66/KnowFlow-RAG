...
This file is the agent-facing working agreement for the `KnowFlow` repository.

## Purpose

KnowFlow (派聪明) is an enterprise AI knowledge management system built around a RAG workflow:
...
KnowFlow uses organization tags and user/org relationships.
