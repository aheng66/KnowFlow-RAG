package com.yizhaoqi.knowflow.utils;
...
public class LogUtils {
    ...
    // 业务日志记录器
    private static final Logger BUSINESS_LOGGER = LoggerFactory.getLogger("com.yizhaoqi.knowflow.business");
    
    // 性能日志记录器
    private static final Logger PERFORMANCE_LOGGER = LoggerFactory.getLogger("com.yizhaoqi.knowflow.performance");
