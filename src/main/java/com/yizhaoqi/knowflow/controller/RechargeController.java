...
import com.yizhaoqi.knowflow.service.RechargeService;
import com.yizhaoqi.knowflow.service.WxPayService;
...
public class RechargeController {
    ...
    public ResponseEntity<?> getPackages() {
        try {
            List<com.yizhaoqi.knowflow.model.RechargePackage> packages = rechargeService.getAllPackages();
